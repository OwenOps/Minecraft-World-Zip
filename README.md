...
4. Zipped worlds show up in the list (marked **Zipped**, with size and icon). Folder worlds show disk size too, so you can see what is worth zipping. Edit and Recreate stay off until the world is a folder again.
